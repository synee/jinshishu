...
from app.forms.widgets import CheckboxSelectMultiple as NgCheckboxSelectMultiple
...
class NgFormBaseMixin(object):
    form_error_css_classes = 'form-errors list-unstyled'
    field_error_css_classes = 'field-errors  list-unstyled'
    ...
    def convert_widgets(self, data):
        ...
        for name, field in self.base_fields.items():
            if isinstance(field, fields.MultipleChoiceField) and isinstance(field.widget, widgets.CheckboxSelectMultiple):
                ...
                field.widget = NgCheckboxSelectMultiple()
